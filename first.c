...
int main(){
  ...
  //The way that the scanf function works:
  // scanf("the symbol for data type", &name);
  //symbols for data type: char: %c , int: %d, float:%e %E %f %G %g, 
  //char[]:%s, unsigned int: %u, int(octal): %o, int(hex):%x %X 
